...
class CrontabSchedule(db.Model):
    __tablename__ = '{}_celery_crontabs'.format(table_name_prefix)
    __bind_key__ = 'main'
    __table_args__ = {
        'mysql_engine': 'InnoDB',
        'mysql_charset': 'utf8'
...
class IntervalSchedule(db.Model):
    __tablename__ = '{}_celery_intervals'.format(table_name_prefix)
    __bind_key__ = 'main'
    __table_args__ = {
        'mysql_engine': 'InnoDB',
        'mysql_charset': 'utf8'
...
class DatabaseSchedulerEntry(db.Model):
    __tablename__ = '{}_celery_schedules'.format(table_name_prefix)
    __bind_key__ = 'main'
    __table_args__ = {
        'mysql_engine': 'InnoDB',
        'mysql_charset': 'utf8'
    ...
    interval_id = db.Column(db.Integer, db.ForeignKey('{}_celery_intervals.id'.format(table_name_prefix)))
    crontab_id = db.Column(db.Integer, db.ForeignKey('{}_celery_crontabs.id'.format(table_name_prefix)))
...
class TaskResult(db.Model):
    """Task result/status."""
    __tablename__ = '{}_celery_taskmeta'.format(table_name_prefix)
    __bind_key__ = 'main'
    __table_args__ = {
...
class TaskSetResult(db.Model):
    """TaskSet result"""
    __tablename__ = '{}_celery_tasksetmeta'.format(table_name_prefix)
    __bind_key__ = 'main'
    __table_args__ = {
        'sqlite_autoincrement': True,
        'mysql_engine': 'InnoDB',
...
class SchedulerHistory(db.Model):
    __tablename__ = '{}_celery_schedules_history'.format(table_name_prefix)
    __bind_key__ = 'main'
    __table_args__ = {
        'mysql_engine': 'InnoDB',
        'mysql_charset': 'utf8'
...
class TaskHistory(db.Model):
    __tablename__ = '{}_celery_task_history'.format(table_name_prefix)
    __bind_key__ = 'main'
    __table_args__ = {
        'mysql_engine': 'InnoDB',
        'mysql_charset': 'utf8'
